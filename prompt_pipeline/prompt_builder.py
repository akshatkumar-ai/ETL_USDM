...
- Do NOT elaborate or explain endpoints.
- Do NOT rewrite protocol language.
- Use the exact protocol wording whenever possible.
- Prefer short phrases over full sentences.
- Do NOT generate narrative explanations.
- Keep text fields under 1 sentence.
- Minimize verbosity.
"""
